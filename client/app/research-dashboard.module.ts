...
const routes: Routes = [
  {
    path: "",
    component: ResearchFrameComponent,
    children: [
      {
        path: "",
        component: ResearchHomeFrameComponent,
        children: [
          { path: "", redirectTo: "experiments", pathMatch: "full" },
          {
            path: "status",
            component: ServerStatusOverviewComponent,
            canActivate: [ResearcherAuthGuardSecure]
          },
          {
            path: "settings",
          ...
          {
            path: "account",
            component: ResearcherAccountSettingsComponent,
            canActivate: [ResearcherAuthGuardSecure]
          }
        ]
      },
      {
        ...
        loadChildren: () =>
          import("./experiment-dashboard.module").then(
            m => m.ExperimentDashboardModule
          )
      }
    ]
  }
